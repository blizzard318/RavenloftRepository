        ...
        void AddI6Ravenloft()
        {
            ...
            var Barovia = ctx.CreateDomain("Barovia")
                .AddItems(
                    ...
                    ctx.CreateLocation("The Svalich Woods", 1, 6, 7, 8).AddTraits(Traits.Creature.Worg),
            ...
            var VillageOfBarovia = ctx.CreateLocation("Village of Barovia", 1, 6, 7).AddDomains(Barovia).AddTraits(Traits.Location.Settlement, Traits.Settlement.VillageOfBarovia, Traits.Location.Vistani);
            ...
            var BloodVineTavern = ctx.CreateLocation("Blood of the Vine Tavern", 8, 9).AddDomains(Barovia).AddTraits(Traits.Settlement.VillageOfBarovia, Traits.Location.Vistani).AddInfo("Also known as 'Blood on the Vine' Tavern.");
            ...
            ctx.CreateNPC("Madam Eva").AddTraits(Traits.Status.Vistani, Traits.Race.Human, Traits.Alignment.CN, Traits.Status.Raunie)
                .AddLocations(
                    ctx.CreateLocation("Tser Pool Encampment", 11).AddDomains(Barovia).AddTraits(Traits.Location.Vistani, Traits.Location.Settlement, Traits.Settlement.TserPoolEncampment),
                    ctx.CreateLocation("Madam Eva's Tent", 11).AddDomains(Barovia).AddTraits(Traits.Location.Vistani, Traits.Settlement.TserPoolEncampment)
                );

            var CastleRavenloft = ctx.CreateLocation("Castle Ravenloft").AddDomains(Barovia).AddTraits(Traits.Location.Darklord)
                .AddNPCs(
                    ...
                    ctx.CreateNPC("Prince Aeial Du Plumette", 27).AddTraits(Traits.Alignment.LE, Traits.Creature.Ghost).AddInfo("Also known as 'Aerial the Heavy'."),
            ...
            var BildrathParents = ctx.CreateNPC("Bildrath Parents", 8).AddTraits(Traits.NoLink);
            var BildrathSibling = ctx.CreateNPC("Bildrath Sibling", 8).AddTraits(Traits.NoLink);
