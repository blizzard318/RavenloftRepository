...
internal static partial class AddToDatabase
{
    public static void Add0 () 
    {
        ...
        void AddI6Ravenloft()
        {
            ...
            DomainEnum.Barovia.AddGroup(GroupEnum.Raunie, "1, 6, 11, 32").BindGroups(GroupEnum.Vistani);
            DomainEnum.Barovia.AddGroup(GroupEnum.Vistani, "1, 4, 7, 11, 28").BindLocations(Settlement.TserPoolEncampment, LocationEnum.MadamEvasTent);
            DomainEnum.Barovia.AddGroup(GroupEnum.EvaVistani, "1, 4, 7, 11, 28").BindGroups(GroupEnum.Vistani);
        ...
        void AddI10TheHouseOnGryphonHill()
        {
            ...
            DomainEnum.Mordent.AddLocation(LocationEnum.MordentMarketStreet, "Map");
        ...
        void AddRealmOfTerror()
        {
            ...
            DomainEnum.Markovia.AddLivingDarklord(DarklordEnum.FrantisekMarkov, "3, 76, 102-103").BindAlignment(Alignment.LE).BindCharacters(CharacterEnum.LudmillaMarkov).BindDomains(DomainEnum.Barovia).BindRelatedCreatures(Creature.Pig).BindCloseBorder("A mist rises at the borders, unlike other vapors in the core, this one causes excruciating pain to anyone who enters. The pain is incapacitating - leading first to paralysis (over 1d4 rounds), then madness. Only one thing alleviates it: stepping back towards the heart of Markovia.").BindCurse("He must always have the body of a beast, and so, like his creations, he is hideously disformed. Frantisek desperately wants to be a normal human again.").BindLair(LocationEnum.MarkovEstate);
            ...
            DomainEnum.Barovia.AddLivingCharacter(CharacterEnum.MadamEva, "9, 36, 89, 117").BindGroups(GroupEnum.EvaVistani, GroupEnum.Vistani);
            ...
            DomainEnum.Barovia.AddDeadCharacter(CharacterEnum.LudmillaMarkov, "104-105");
            ...
            DomainEnum.Barovia.AddSettlement(Settlement.TserPoolEncampment, "Map").BindLocations(LocationEnum.TserPool);
